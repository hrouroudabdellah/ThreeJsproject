...
const {color , scale , setColor ,setScale } = useMacbookStore();
  ...
  return (
    <section
      id="product-viewer"
      className="bg-black text-white gap-5 flex flex-col  "
    >
        
      <h2 className="text-4xl">Take a closer look.</h2>
      <div className="controls">
        <p className="info">MackBookPro {scale} in  {color} </p>

        <div className="flex-center gap-5 mt-5">
          <div  className="color-control">
            <div onClick={() => setColor ('#adb5db')} className={clsx('bg-neutral-300', color === '#adb5bd' && 'active')}/>
